...
var translations = map[Lang]map[TranslationKey]string{
	LangEN: {
		...
		KeyLogWatching:             "configuration correct - watching files",
		...
		KeyStartupEnableConfirm:  "Add Ajit to system startup?\nIt will launch automatically when you log in.",
		KeyStartupDisableConfirm: "Remove Ajit from system startup?",
	...
	LangPL: {
		...
		KeyLogWatching:             "konfiguracja poprawna - obserwowanie plików",
		...
		KeyStartupEnableConfirm:  "Dodać Ajit do autostartu?\nAplikacja będzie uruchamiana automatycznie po zalogowaniu.",
		KeyStartupDisableConfirm: "Usunąć Ajit z autostartu?",
	...
	LangUA: {
		...
		KeyLogWatching:             "конфігурація правильна - спостереження за файлами",
		...
		KeyStartupEnableConfirm:  "Додати Ajit до автозапуску?\nПрограма запускатиметься автоматично при вході.",
		KeyStartupDisableConfirm: "Видалити Ajit з автозапуску?",
	...
	LangRU: {
		...
		KeyLogWatching:             "конфигурация верна - наблюдение за файлами",
		...
		KeyStartupEnableConfirm:  "Добавить Ajit в автозапуск?\nПриложение будет запускаться автоматически при входе.",
		KeyStartupDisableConfirm: "Удалить Ajit из автозапуска?",
